...
const TripSummary = ({ user }) => {
    ...
    useEffect(() => {
        ...
        const fetchTripDetails = async () => {
            try {
                // Fetch Trip Details
                const tripRes = await fetch(`https://triplens-duml.onrender.com/trips/getTripById?tripId=${tripId}`, {
                    method: 'POST'
                });
                ...
                if (tripRes.ok) {
                    ...
                    if (tripData.itineraryId) {
                        try {
                            const itinRes = await fetch(`https://triplens-duml.onrender.com/api/itineraries/getItinerary?itineraryId=${tripData.itineraryId}`, {
                                method: 'POST'
                            });
                            if (itinRes.ok) {
