...
const Login = ({ onLogin }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // 1. Authenticate
            const authResponse = await fetch('http://https://triplens-duml.onrender.com/users/authenticate', {
                method: 'POST',
            ...
            if (isAuthenticated) {
                // 2. Get User Details
                const userResponse = await fetch('http://https://triplens-duml.onrender.com/users/finduser', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
